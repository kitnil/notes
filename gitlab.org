...
- [[https://github.com/junkdog/glim][junkdog/glim: A TUI for monitoring GitLab CI/CD pipelines and projects]]
...
- [[https://github.com/timo-reymann/gitlab-ci-verify][timo-reymann/gitlab-ci-verify: Validate and lint your gitlab ci files using ShellCheck, the Gitlab API, curated checks or even build your own checks]]

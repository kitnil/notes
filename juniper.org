...
- netstat
  [[https://kb.juniper.net/InfoCenter/index?page=content&id=KB21222&cat=SRX_SERIES&actp=LIST][origin: [Junos] How to identify the process that is listening on a specific port - Juniper Networks]]

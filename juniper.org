...
- tail -f /var/log/{mastership,jam_dfwd,jam_chassisd,inventory,chassisd_snmp,dcd_commit_check,erp-default,dcd,chassisd,mib2d.1.gz,snmpd.1.gz,wtmp,messages,snmpd,mib2d,log-bgp}

...
Введите сумму 20 + 19
* Tools
- [[https://github.com/adocilesloth/SRBeep][adocilesloth/SRBeep: Plays a sound when obs-studio starts/stops streaming/recording]]
...
- [[https://github.com/a-rose/obs-headless][a-rose/obs-headless: Headless OBS in Docker via gRPC]]
...
- [[https://github.com/baffler/OBS-OpenVR-Input-Plugin][baffler/OBS-OpenVR-Input-Plugin: This OBS plugin provides an input plugin to 64bit OBS that allows capturing directly from OpenVR/SteamVR mirror surface in full resolution.]]
...
- [[https://github.com/Caisesiume/OBS-Mic-Swapper][Caisesiume/OBS-Mic-Swapper: Swaps/Mutes active audio input device in OBS upon a specified channel point redemption in Twitch chat.]]
...
- [[https://github.com/dd-center/obs-streamlink][dd-center/obs-streamlink: OBS source plugin to receive stream using streamlink.]]
...
- [[https://github.com/exeldro/obs-virtual-cam-filter][exeldro/obs-virtual-cam-filter: Plugin for OBS Studio to make sources available to the virtual camera via a filter.]]
...
- [[https://github.com/makidoll/MakiScreen][makidoll/MakiScreen: 📺 Streaming OBS video into maps on item frames at a high frame rate]]
...
- [[https://github.com/mmpneo/curses][mmpneo/curses: Speech to Text and KB input captions for OBS, VRChat, Twitch chat and Discord]]
...
- [[https://github.com/nleseul/obs-ghostscript][nleseul/obs-ghostscript: Video source plugin for OBS which renders PDF and other documents using Ghostscript]]
...
- [[https://github.com/paratustra/tvadblocker][paratustra/tvadblocker: TV Ad blocker using OBS Studio and OpenCV (simple logo detection using template matching)]]
- [[https://github.com/ratwithacompiler/OBS-captions-plugin][ratwithacompiler/OBS-captions-plugin: Closed Captioning OBS plugin using Google Speech Recognition]]
- [[https://github.com/revenkroz/obs-random-text][revenkroz/obs-random-text: OBS plugin to display a random string from a list]]
...
- [[https://github.com/squeek502/obs-txt-trigger][squeek502/obs-txt-trigger: OBS script to use a text file as a trigger for making sources temporarily visible]]
...
- [[https://github.com/t2t2/obs-tablet-remote][t2t2/obs-tablet-remote: Tablet optimised OBS Remote]]
...
- [[https://github.com/upgradeQ/Obscounter][upgradeQ/Obscounter: OBS Studio hotkey based counter]]
- [[https://github.com/upgradeQ/obs-libre-macros][upgradeQ/obs-libre-macros: :8ball: Scripting and macros hotkeys in OBS Studio for Humans]]

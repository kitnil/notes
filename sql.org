...
- [[https://github.com/frectonz/sql-studio][frectonz/sql-studio: SQL Database Explorer [SQLite, libSQL, PostgreSQL, MySQL/MariaDB, ClickHouse, Microsoft SQL Server]]]
...
- [[https://github.com/mickamy/sql-tap][mickamy/sql-tap: Watch SQL traffic in real-time with a TUI]]
...
- [[https://github.com/theseus-rs/rsql][theseus-rs/rsql: Command line SQL interface for relational databases and common data file formats]]
- [[https://github.com/xnacly/sqleibniz][xnacly/sqleibniz: Static analysis and LSP for SQL in Rust]]

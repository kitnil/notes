...
- [[https://github.com/arianvp/cgroup-exporter][arianvp/cgroup-exporter: This is a lightweight Prometheus exporter for cgroups that only supports the unified cgroup v2 hierarchy. It exposes usage metrics for each cgroup in the hierarchy.]]
...
- [[https://github.com/blancvpn/service-region-exporter][blancvpn/service-region-exporter: Prometheus exporter that monitors and verifies geographic region detection by various online services.]]
- [[https://github.com/blind-oracle/cortex-tenant][blind-oracle/cortex-tenant: Prometheus remote write proxy that adds Cortex/Mimir tenant ID based on metric labels]]
...
- [[https://github.com/digitalocean-labs/ebpf_exporter][digitalocean-labs/ebpf_exporter: a pure-Go Prometheus exporter for the eBPF Linux subsystem]]
...
- [[https://github.com/henrywhitaker3/prompage][henrywhitaker3/prompage: Prometheus-based status page]]
- [[https://github.com/hikhvar/mqtt2prometheus][hikhvar/mqtt2prometheus: MQTT to Prometheus gateway]]
- [[https://github.com/hikhvar/ts3exporter][hikhvar/ts3exporter: Teamspeak 3 exporter for prometheus]]
...
- [[https://github.com/jakthom/hercules][jakthom/hercules: A DuckDB-powered Prometheus exporter]]
- [[https://github.com/joe-elliott/cert-exporter][joe-elliott/cert-exporter: A Prometheus exporter that publishes cert expirations on disk and in Kubernetes secrets]]
...
- [[https://github.com/prometheus-eval/prometheus-eval][prometheus-eval/prometheus-eval: Evaluate your LLM's response with Prometheus 💯]]
...
- [[https://github.com/quyxishi/whitebox][quyxishi/whitebox: whitebox is a Prometheus exporter that provides availability monitoring of external VPN services powered by VMESS, VLESS, TROJAN, WireGuard and Shadowsocks.]]
...
- [[https://github.com/sapcc/ntp_exporter][sapcc/ntp_exporter: Prometheus exporter for NTP offset/stratum of a client]]
...
- [[https://github.com/SoulKyu/notificator][SoulKyu/notificator: Notificator is a Karma replacement for alertmanager with sounds and notifications]]
...
- [[https://github.com/SuperQ/chrony_exporter][SuperQ/chrony_exporter: Exporter for Chrony NTP]]
- [[https://github.com/SuperQ/smokeping_prober][SuperQ/smokeping_prober: Prometheus style smokeping]]

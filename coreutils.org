...
- [[https://github.com/AmrDeveloper/Lineeditor][AmrDeveloper/Lineeditor: A new cross platform general prupose Line editor implementation designed with the goal to be flexible and customizable]]
...
- [[https://github.com/dlvhdr/diffnav][dlvhdr/diffnav: A git diff pager based on delta but with a file tree, à la GitHub.]]
...
- [[https://github.com/vyrti/cleaner][vyrti/cleaner: Fast disk cleaner / ncdu for Windows, Mac, Linux]]
  - [[https://github.com/ikebastuz/wiper][ikebastuz/wiper: Disk analyser and cleanup tool]]
...
- ls :: [[https://the.exa.website][exa]]
  ...
  - [[https://github.com/yellow-footed-honeyguide/facad][yellow-footed-honeyguide/facad: A modern, colorful ls alternative for bringing clarity to the filesystem ☀️]]
- ps :: [[https://github.com/dalance/procs][procs]]
  ...
  - print process tree
    : ps axjf
  - [[https://github.com/loresuso/psc][loresuso/psc: the ps utility, with an eBPF twist and container context]]

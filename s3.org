...
- [[https://github.com/Barre/ZeroFS][Barre/ZeroFS: ZeroFS - The Filesystem That Makes S3 your Primary Storage. ZeroFS is 9P/NFS/NBD on top of S3. Initially built for www.merklemap.com]]
- [[https://github.com/BemiHQ/BemiDB][BemiHQ/BemiDB: Open-source Snowflake and Fivetran alternative bundled together]]
...
- [[https://github.com/rajsinghtech/garage-operator][rajsinghtech/garage-operator: A Kubernetes operator for managing Garage - a distributed S3-compatible object storage system designed for self-hosting.]]
- [[https://github.com/rustfs/rustfs][rustfs/rustfs: RustFS is an open-source, S3-compatible high-performance object storage system supporting migration and coexistence with other S3-compatible platforms such as MinIO and Ceph.]]

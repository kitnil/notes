...
- [[https://github.com/antiboredom/videogrep][antiboredom/videogrep: automatic video supercuts with python]]
- [[https://github.com/bluenviron/mediacommon?tab=readme-ov-file][bluenviron/mediacommon: Entities shared between gohlslib, gortsplib, gortmplib, MediaMTX]]
...
- [[https://github.com/clearlysid/rustymotion][clearlysid/rustymotion: A Rust-based renderer for Remotion videos.]]
- [[https://github.com/CMU-Perceptual-Computing-Lab/openpose][CMU-Perceptual-Computing-Lab/openpose: OpenPose: Real-time multi-person keypoint detection library for body, face, hands, and foot estimation]]
- [[https://github.com/digimezzo/vitomu][digimezzo/vitomu: Easy to use video to audio converter]]
- [[https://github.com/dmlc/decord][dmlc/decord: An efficient video loader for deep learning with smart shuffling that's super easy to digest]]
- [[https://github.com/emin-ozata/lazycut][emin-ozata/lazycut: A simple terminal UI for video trimming]]
...
- [[https://github.com/FujiwaraChoki/MoneyPrinter][FujiwaraChoki/MoneyPrinter: Automate Creation of YouTube Shorts using MoviePy.]]
...
- [[https://github.com/gausian-AI/Gausian_native_editor][gausian-AI/Gausian_native_editor: Gausian - Rust-based local video editor for AI video production]]
...
- [[https://github.com/IogaMaster/videos][IogaMaster/videos: Source code of my YouTube videos animated with MotionCanvas]]
...
- [[https://github.com/jordandelbar/yolo-tonic][jordandelbar/yolo-tonic: Webcam video stream with real-time YOLO object detection, built with Ort, Tonic and Axum.]]
- [[https://github.com/Kurento/kurento][Kurento/kurento: Kurento WebRTC Media Server]]
...
- [[https://github.com/mltframework/shotcut][mltframework/shotcut: cross-platform (Qt), open-source (GPLv3) video editor]]
- [[https://github.com/olive-editor/olive][olive-editor/olive: Free open-source non-linear video editor]]
- [[https://github.com/OpenCut-app/OpenCut][OpenCut-app/OpenCut: The open-source CapCut alternative]]
- [[https://github.com/open-mmlab/mmyolo][open-mmlab/mmyolo: OpenMMLab YOLO series toolbox and benchmark]]
- [[https://gitlab.com/osp-group/flask-nginx-rtmp-manager][Open Streaming Platform / open-streaming-platform: A Self-Hosted Video Streaming and Recording Server Using Python, Flask, Nginx-RTMP. · GitLab]]
...
- [[https://github.com/ozencb/couchtube][ozencb/couchtube: 📺 A self-hosted, YouTube based application that recreates the feel of a TV channel. CouchTube schedules YouTube video playback dynamically from user-defined channel lists. Customize, share, and submit JSON-based playlists to make CouchTube your own!]]
...
- [[https://github.com/SuperFlyTV/SuperConductor][SuperFlyTV/SuperConductor: A playout client for Windows/Linux/macOS that will let you control CasparCG Server, BMD ATEM, OBS Studio, vMix, OSC-compatible devices, HTTP (REST)-compatible devices, and more!]]
- [[https://github.com/svanichkin/say][svanichkin/say: say - command line tool for voice and video calling]]
...
- [[https://github.com/tonghohin/screen-sharing][tonghohin/screen-sharing: Screen Sharing Application. A real-time screen sharing application built with Next.js, WebRTC, and PeerJS. Create or join rooms to share your screen with others instantly.]]
- [[https://github.com/vasanthv/talk][vasanthv/talk: Group video call for the web. No signups. No downloads.]]
- [[https://github.com/VERT-sh/vertd][VERT-sh/vertd: VERT's solution to crappy video conversion services.]]
...
- [[https://github.com/zobtube/zobtube][zobtube/zobtube: ZobTube is a library viewer and management tools for adult videos.]]
** Streaming
...
* Memes
  ...
  - [[https://www.youtube.com/watch?v=n60oHsr_QS4][Геннадий Горин - Не двигайте табуретками! - YouTube]]

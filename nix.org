...
* Misc
- [[https://github.com/generic-github-user/nixlang-raytracer][generic-github-user/nixlang-raytracer: Raytracer written in pure Nix]]
...
* NixOS
- [[https://github.com/km-clay/nixos-wizard][km-clay/nixos-wizard: A TUI installer for NixOS]]
...
- [[https://github.com/Athena-OS/athena-nix][Athena-OS/athena-nix: Athena OS is a NixOS-based distro focused on Cybersecurity. Learn, practice and enjoy with any hacking tool!]]
- [[https://github.com/h4ckbs/lan-party-netboot][h4ckbs/lan-party-netboot: NixOS setup to boot a bunch of computers into the same desktop environment with games pre-installed]]
...
- [[https://github.com/peter-marshall5/nixlet][peter-marshall5/nixlet: Mini Nix-based embedded OS]]
- [[https://github.com/nix-community/nixos-cli][nix-community/nixos-cli: nixos is an experimental modern replacement for nixos-rebuild]]
...
** Systemd Container
*** Build
The following shows how to build a container with NixOS and systemd as a
PID 1.  Copy all example files and build a container with command:
...
*** Running
You can run the builded container in a Docker or in a Kubernetes Pod.
Make sure to push the image in a container registry before runnning.
#+begin_src yaml
apiVersion: v1
kind: Namespace
metadata:
...
spec:
  ...
  - command:
    ...
    - name: container
      value: docker
    image: example.org/nixos/nixos-systemd:latest
    livenessProbe:
      exec:
        command:
...
- [[https://github.com/numtide/nix-auth][numtide/nix-auth: Nix access-token management tool]]
...
* Tools
- [[https://github.com/abathur/resholve][abathur/resholve: a shell resolver? :) (find and resolve shell script dependencies)]]
- [[https://github.com/AdoPi/shoji-nix][AdoPi/shoji-nix: Manage your SSH keys with Nix]]
- [[https://github.com/AleXoundOS/mirror-nix][AleXoundOS/mirror-nix: mirror Nix binary cache for the offline workflow]]
- [[https://github.com/antithesishq/madness][antithesishq/madness: Madness enables you to easily run the same binary on NixOS and non-NixOS systems]]
...
- [[https://github.com/BatteredBunny/brew-nix][BatteredBunny/brew-nix: Experimental nix expression to package all MacOS casks from homebrew automatically]]
- [[https://github.com/bluskript/nix-inspect][bluskript/nix-inspect: Interactive tui for inspecting nix configs]]
...
- [[https://github.com/briheet/ns-tui][briheet/ns-tui: A beautiful terminal interface for searching Nixpkgs, HM options in real-time.]]
...
- [[https://github.com/cafkafk/nix-weather][cafkafk/nix-weather: Check Cache Availablility of NixOS Configurations]]
- [[https://github.com/cafkafk/rime][cafkafk/rime: Nix Flake Input Versioning]]
- [[https://github.com/cdepillabout/evil-nix][cdepillabout/evil-nix: A Nix library to download files from the internet without requiring a hash]]
...
- [[https://github.com/cynicsketch/nix-mineral][cynicsketch/nix-mineral: NixOS module for convenient system hardening.]]
...
- [[https://github.com/DeterminateSystems/flake-checker][DeterminateSystems/flake-checker: Health checks for your Nix flakes]]
...
- [[https://github.com/ekala-project/eka-ci][ekala-project/eka-ci: CI/CD tool and web frontend for nix package sets]]
- [[https://github.com/faukah/dix][faukah/dix: Diff Nix]]
...
- [[https://github.com/fricklerhandwerk/lazy-run][fricklerhandwerk/lazy-run: Build executables from Nix derivations on demand.]]
...
- [[https://github.com/juspay/services-flake?tab=readme-ov-file][juspay/services-flake: NixOS-like services for Nix flakes]]
- [[https://github.com/jzbor/nix-sweep][jzbor/nix-sweep: Utility to clean up old Nix profile generations and left-over garbage collection roots]]
...
- [[https://github.com/LGUG2Z/nixos-multi-machine-starter][LGUG2Z/nixos-multi-machine-starter: A sane, batteries-included starter template for running NixOS on Multiple Machines]]
...
- [[https://github.com/LordGrimmauld/nix-check-deps][LordGrimmauld/nix-check-deps: scan nix packages for unused buildInputs]]
...
- [[https://github.com/Naxdy/nix-bwrapper][Naxdy/nix-bwrapper: A user-friendly method of sandboxing applications using bubblewrap with portals support.]]
- [[https://github.com/nikstur/lon][nikstur/lon: Lock & update Nix dependencies]]
...
- [[https://github.com/nix-community/nix-ld-rs][nix-community/nix-ld-rs: Run unpatched dynamic binaries on NixOS [maintainer=@zhaofengli @Mic92]]]
...
- [[https://github.com/nix-community/patsh][nix-community/patsh: A command-line tool for patching shell scripts inspired by resholve [maintainer=@figsoda]]]
...
- [[https://github.com/nixops4/nixops4][nixops4/nixops4: Deploy with Nix and manage resources declaratively]]
- [[https://github.com/NixOS/nixpkgs-vet][NixOS/nixpkgs-vet: Tool to vet (check) Nixpkgs, including its pkgs/by-name directory]]
...
- [[https://github.com/noamraph/nixsa][noamraph/nixsa: Nixsa - A Nix Standalone Environment]]
...
- [[https://github.com/numtide/nix-vm-test][numtide/nix-vm-test: Re-use the NixOS VM test infrastructure to test Ubuntu, Debian, and Fedora machines.]]
...
- [[https://github.com/oddlama/nix-topology?tab=readme-ov-file][oddlama/nix-topology: 🍁 Generate infrastructure and network diagrams directly from your NixOS configurations]]
- [[https://github.com/olafkfreund/nix-ai-help][olafkfreund/nix-ai-help: Ai based nix help system from the command line.]]
...
- [[https://github.com/Platonic-Systems/process-compose-flake][Platonic-Systems/process-compose-flake: A `flake-parts` module to spin up processes for development by leveraging `process-compose`]]
- [[https://github.com/Platonic-Systems/secrix][Platonic-Systems/secrix: Secrex is based on ideas in agenix, however is written from the ground up.]]
- [[https://github.com/polygon/nix-buildproxy][polygon/nix-buildproxy: Providing reproducible HTTP/HTTPS responders to builds that just can not live without]]
...
- [[https://github.com/rasmus-kirk/nixarr][rasmus-kirk/nixarr: The Media Server Nixos Module]]
...
- [[https://github.com/soltros/configbuilder][soltros/configbuilder: A configurator that allows for the automatic generation of configuration.nix with pluggable nix modules.]]
...
- [[https://github.com/viperML/activation-manager][viperML/activation-manager]]
- [[https://github.com/viperML/noshell][viperML/noshell: user-configurable login shell]]

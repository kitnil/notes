...
- [[https://github.com/atinylittleshell/gsh][atinylittleshell/gsh: A modern, POSIX-compatible, generative shell]]
...
- [[https://github.com/cornerpirate/socat-shell][cornerpirate/socat-shell: Socat can be used to establish a reverse shell with bash tab completion and full shell functionality]]
- [[https://github.com/ellie/atuin][ellie/atuin: Magical shell history]]
- [[https://github.com/eminwux/sbsh?tab=readme-ov-file][eminwux/sbsh: 🚂 sbsh brings Terminal-as-Code to your workflow, making terminal environments reproducible, persistent, and safe to share across your team.]]
...
- [[https://github.com/qianlan-max/icmp_shell][qianlan-max/icmp_shell: icmp隧道远控工具，支持交互式shell(session/beacon)、文件传输，可选通讯加密方式、包步态等，在流量对抗上做了增强。]]
- [[https://github.com/raphamorim/flash][raphamorim/flash: ⚡ shell parser, formatter, and interpreter with Bash support]]
...
- [[https://github.com/yassinebenaid/bunster][yassinebenaid/bunster: Compile shell scripts to static binaries.]]

...
#+LATEX_HEADER: \hypersetup{colorlinks, citecolor=black, filecolor=black, linkcolor=black, urlcolor=blue, pdfpagemode=FullScreen, unicode}
...
** Evaluate to get a matrix of minors
...
** Get cofactor matrix from matrix of minors

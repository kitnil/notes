...
* Tools
- [[https://github.com/carthage-software/mago][carthage-software/mago: Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.]]
...
- [[https://github.com/paramientos/presto][paramientos/presto: Presto is a dependency manager for PHP and drop-in-replacement for Composer]]
- [[https://github.com/php-any/origami][php-any/origami: Origami-lang is an innovative hybrid scripting language that deeply integrates PHP's rapid development capabilities with Go's efficient concurrency model. It also incorporates some Java and TypeScript conventions.]]

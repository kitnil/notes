...
- [[https://github.com/DhananjayPurohit/ngx_l402][DhananjayPurohit/ngx_l402: nginx module for L402 authentication to enable Lightning Network-based API monetization]]
- [[https://github.com/digitalocean/nginxconfig.io][digitalocean/nginxconfig.io: ⚙️ NGiИX config generator on steroids 💉]]
- [[https://github.com/facundoolano/ngtop][facundoolano/ngtop: nginx access logs analytics]]
...
- [[https://github.com/nginx/nginx-acme][nginx/nginx-acme: An NGINX module with the implementation of the automatic certificate management (ACMEv2) protocol]]
...
- [[https://github.com/veo/nginx_shell][veo/nginx_shell: nginx WebShell/内存马，更优雅的nignx backdoor]]

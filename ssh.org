...
- [[https://github.com/Adembc/lazyssh][Adembc/lazyssh: A terminal-based SSH manager inspired by lazydocker and k9s - Written in go]]
- [[https://github.com/AkihiroSuda/sshocker][AkihiroSuda/sshocker: ssh + reverse sshfs + port forwarder, in Docker-like CLI]]
- [[https://github.com/alebeck/boring][alebeck/boring: The `boring` SSH tunnel manager]]
- [[https://github.com/AlpinDale/ssh-dashboard][AlpinDale/ssh-dashboard: Monitor GPU/CPU Usage on SSH servers, with NVIDIA and AMD support.]]
...
- [[https://github.com/ashfn/islechat][ashfn/islechat: chat server powered by SSH]]
- [[https://github.com/AthenaNetworks/ssh_commander][AthenaNetworks/ssh_commander: Run sequential command(s) on a group of SSH servers]]
...
- [[https://github.com/bryanpkc/corkscrew][bryanpkc/corkscrew: A tool for tunneling SSH through HTTP proxies]]
- [[https://github.com/byawitz/ggh][byawitz/ggh: Recall your SSH sessions (also search your SSH config file)]]
- [[https://github.com/caelansar/termirs][caelansar/termirs: A modern, async SSH terminal client]]
...
- [[https://github.com/CompeyDev/ssh-portfolio][CompeyDev/ssh-portfolio: introducing a portfolio as a tui app served over ssh!]]
...
- [[https://github.com/cvhariharan/qssh][cvhariharan/qssh: SSH over QUIC]]
- [[https://github.com/d3witt/viking][d3witt/viking: Simple way to manage your remote machines and SSH keys]]
...
- [[https://github.com/devmegablaster/bashform][devmegablaster/bashform: Create and share forms in the terminal over SSH]]
...
- [[https://github.com/engity-com/bifroest][engity-com/bifroest: Highly customizable SSH server with several ways to authorize a user and options where and how to execute a user's session.]]
...
- [[https://github.com/eznix86/mssh][eznix86/mssh: Enable SSH access to machines behind NAT without a VPN]]
...
- [[https://github.com/francoismichel/ssh3][francoismichel/ssh3: SSH3: faster and rich secure shell using HTTP/3, checkout our article here: https://arxiv.org/abs/2312.08396 and our Internet-Draft: https://datatracker.ietf.org/doc/draft-michel-ssh3/]]
...
- [[https://github.com/Gu1llaum-3/sshm][Gu1llaum-3/sshm: SSHM is a beautiful command-line tool that transforms how you manage and connect to your SSH hosts. Built with Go and featuring an intuitive TUI interface, it makes SSH connection management effortless and enjoyable.]]
...
- [[https://github.com/janmojzis/tinyssh][janmojzis/tinyssh: TinySSH is small server (less than 100000 words of code)]]
- [[https://github.com/JayanAXHF/filessh][JayanAXHF/filessh: A fast and convenient TUI file browser for remote servers]]
...
- [[https://github.com/judsenb/GateKeeper][judsenb/GateKeeper: Self-hosted SSH access gateway in Go with OIDC/LDAP auth, RBAC, MFA, session recording, audit export, encryption at rest, IP rules, and policy enforcement.]]
...
- [[https://github.com/movsb/tcp-over-bt][movsb/tcp-over-bt: SSH into your Linux Machine (e.g. headless Raspberry Pi) from Bluetooth.]]
...
- [[https://github.com/paramientos/leap][paramientos/leap: Leap is a ssh connection manager]]
- [[https://github.com/PeronGH/cli2ssh][PeronGH/cli2ssh: Turn any CLI program into a SSH server]]
- [[https://github.com/pressly/sup][pressly/sup: Super simple deployment tool - think of it like 'make' for a network of servers]]
- [[https://github.com/quantumsheep/sshs][quantumsheep/sshs: Terminal user interface for SSH]]
- [[https://github.com/runZeroInc/sshamble][runZeroInc/sshamble: SSHamble: Unexpected Exposures in SSH]]
- [[https://github.com/rustonbsd/iroh-ssh][rustonbsd/iroh-ssh: SSH to any machine without ip]]
- [[https://github.com/RyanCode/Sectran][RyanCode/Sectran: Sectran provides web-based access control and access management, supporting H5 access for SSH, Telnet (RDP support coming soon), along with local tool proxies. It also offers user operation recording and detailed event auditing.]]
- [[https://github.com/skariel/keypub][skariel/keypub: the public ssh public key registry!]]
- [[https://github.com/skx/knownfs][skx/knownfs: A FUSE-based filesystem that exports ~/.ssh/known_hosts]]
- [[https://github.com/soulteary/ssh-config][soulteary/ssh-config: 1MB size, 99%+ Coverage, Use more expressive YAML / JSON to manage your Config files. --- 1MB大小，99%+ 测试覆盖，使用更具表现力的YAML / JSON来管理您的配置文件。]]
...
- [[https://github.com/strandnerd/tunn][strandnerd/tunn: SSH tunnels made simple: Launch and monitor SSH tunnels from a single YAML config and your existing OpenSSH setup.]]
...
- [[https://github.com/NHAS/reverse_ssh][NHAS/reverse_ssh: SSH based reverse shell]]
- [[https://github.com/stealth/sshttp][stealth/sshttp: SSH/HTTP(S) multiplexer. Run a webserver and a sshd on the same port w/o changes.]]
...
* Alternatives
- [[https://github.com/stealth/crash][stealth/crash: crypted admin shell: SSH-like strong crypto remote admin shell for Linux, BSD, Android, Solaris and OSX]]
- [[https://github.com/stealth/psc][stealth/psc: E2E encryption for multi-hop tty sessions or portshells + TCP/UDP port forward]]

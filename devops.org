...
|                                                     | GitLab                                 | Jenkins                                      |
|                                                     |                                        |                                              |
| Proprietary features (Vendor locking)               | Locked features by EE edition          | Everything is free and opensource            |
| Locking                                             | No, could not use parallel builds      | Yes, E.g. could lock Docker registry         |

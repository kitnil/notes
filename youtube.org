...
* Tools
- [[https://github.com/13unk0wn/Feather][13unk0wn/Feather: Feather is a lightweight, efficient YouTube Music TUI built with Rust. It provides a minimalistic, ad-free music streaming experience directly from YouTube using yt-dlp and mpv, with a focus on low memory usage and fast playback.]]
...
- [[https://api.invidious.io/][Invidious Instances]]
...
- [[https://github.com/Kam1k4dze/SubChat][Kam1k4dze/SubChat: SubChat is a command-line and GUI toolset for generating YouTube subtitles from chat logs.]]
...
- [[https://github.com/kkdai/youtube][kkdai/youtube: Download Youtube Video in Golang]]
  - [[https://github.com/rafalb8/ytfs-go][rafalb8/ytfs-go: YouTube file system written in Go]]
- [[https://github.com/KrishnaSSH/GopherTube][KrishnaSSH/GopherTube: A modern terminal user interface for searching and watching YouTube videos using mpv and chafa]]
...
- [[https://github.com/Milkshiift/YouTubeTLDR][Milkshiift/YouTubeTLDR: ⚡ A lightweight, self-hosted YouTube video summarizer with Gemini AI]]

: mysqldump --master-data=2 --flush-logs --single-transaction --quick
: docker run -p 3307:3306 --name mariadb-10.0 -v /mysql/db-10.0:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=PASS -d docker-registry.intr/webservices/mariadb:10.0
...
- [https://hub.docker.com/_/mariadb?tab=tags][mariadb Tags - Docker Hub]

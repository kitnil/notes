...
- [[https://github.com/chaindead/telegram-mcp][chaindead/telegram-mcp: Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.]]
...
- [[https://github.com/IonRh/TGBot_RSS][IonRh/TGBot_RSS: TGBot_RSS 是一个灵活的利用TGBot信息推送订阅RSS的工具，可通过Bot更方便的管理订阅推送。]]
...
- [[https://github.com/KostyaEsmukov/smtp_to_telegram][KostyaEsmukov/smtp_to_telegram: A simple program that listens for SMTP and forwards all incoming Email messages to Telegram]]
...
- [[https://github.com/RandyVentures/tgcli][RandyVentures/tgcli: Telegram CLI]]
...
* Networks
[[https://core.telegram.org/resources/cidr.txt][cidr list]]
#+begin_example
  91.108.56.0/22
  91.108.4.0/22
  91.108.8.0/22

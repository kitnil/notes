...
- [[https://github.com/cowtoolz/inblog][cowtoolz/inblog: Write a blog from your email]]
- [[https://github.com/happyDomain/happydeliver][happyDomain/happydeliver: Open-source, self-hosted email deliverability testing platform]]
...
- [[https://github.com/Notifuse/notifuse][Notifuse/notifuse: Notifuse is an open-source & modern emailing platform]]
- [[https://github.com/ntk148v/mailproxy][ntk148v/mailproxy: A dead simple mail proxy]]
- [[https://github.com/pimalaya/himalaya][pimalaya/himalaya: CLI to manage emails]]
- [[https://github.com/pimalaya/neverest][pimalaya/neverest: CLI to synchronize, backup and restore emails]]
...
- [[https://github.com/rustmailer/rustmailer][rustmailer/rustmailer: A self-hosted Email Middleware for IMAP, SMTP, Gmail API, Graph API — built for developers]]
- [[https://github.com/sj26/mailcatcher][sj26/mailcatcher: Catches mail and serves it through a dream.]]
- [[https://github.com/soulteary/owlmail][soulteary/owlmail: OwlMail is an SMTP server and web interface for development and testing environments that captures and displays all sent emails.]]
...
- [[https://github.com/tonymet/restmail][tonymet/restmail: restmail sends email from CLI using gmail & outlook rest APIs. It can be used for email automation, notifications and with `git send-mail` for sharing patches.]]
- [[https://github.com/umuterturk/email-verifier][umuterturk/email-verifier: Privacy-first, Free, Open Source email verifier]]
- [[https://github.com/wesm/msgvault][wesm/msgvault: Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB]]
...
- [[https://github.com/aaPanel/BillionMail?tab=readme-ov-file][aaPanel/BillionMail: BillionMail gives you open-source MailServer, NewsLetter, Email Marketing — fully self-hosted, dev-friendly, and free from monthly fees. Join the discord: https://discord.gg/asfXzBUhZr]]
...
- [[https://github.com/hkdb/aerion][hkdb/aerion: An Open Source Lightweight E-Mail Client]]

...
* Tools
- [[https://github.com/coder/wush][coder/wush: simplest & fastest way to transfer files between computers via WireGuard]]
- [[https://github.com/dadevel/wg-netns][dadevel/wg-netns: WireGuard with Linux Network Namespaces]]
- [[https://github.com/irctrakz/wgslirp][irctrakz/wgslirp: A user-space networking (tcp/udp) implementation leveraging wireguard-go]]
- [[https://github.com/puzed/wrapguard][puzed/wrapguard: Userspace WireGuard proxy for transparent network tunneling]]
- [[https://github.com/qinghon/wireguard][qinghon/wireguard: wireguard layer2 mode]]
...
- [[https://github.com/fosrl/pangolin?tab=License-1-ov-file#readme][fosrl/pangolin: Identity-aware VPN and proxy for remote access to anything, anywhere.]]

...
- [[https://github.com/cporter202/scraping-apis-for-devs][cporter202/scraping-apis-for-devs: This GitHub repo is a powerhouse collection of scraping APIs for developers that you can start using immediately to build everything from simple automations to full-scale applications.]]
...
- [[https://github.com/Julien-cpsn/ATAC][Julien-cpsn/ATAC: A simple API client (postman like) in your terminal]]
...
- [[https://github.com/x-sushant-x/Rate-Shield][x-sushant-x/Rate-Shield: A configurable rate limiter that can apply rate limiting on individual APIs with individual rules.]]

...
- [[https://github.com/Ph0enixKM/Amber][Ph0enixKM/Amber: 💎 Amber the programming language compiled to bash]]
...
* Cheatsheet
  ...
  - Populate PATH environment variable with all stores
    : export PATH=$(printf "%s:" /{gnu,nix}/store/*/{bin,sbin}):$PATH
...
: sudo tune2fs -l $(df -h / |(read; awk '{print $1; exit}')) | grep -i created
  ...
  - process substitution with an assigned file descriptor
    : exec 10< <(tail -f file)
    : read line <&10

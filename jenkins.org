...
- [[https://habr.com/ru/companies/swd_es/articles/784396/][Jenkins: оптимизируя динамический пайплайн → распределённая сборка компонентов ОС / Хабр]]
...
- [[https://github.com/daluobai-devops/jenkins-shared-library/tree/main][daluobai-devops/jenkins-shared-library: Jenkins Pipeline Extending with Shared Libraries]]
...
- [[https://github.com/jenkinsci/gitlab-kubernetes-credentials-plugin][jenkinsci/gitlab-kubernetes-credentials-plugin: gitlab-kubernetes-credentials-plugin]]
- [[https://github.com/jenkinsci/global-yaml-properties-plugin][jenkinsci/global-yaml-properties-plugin: Jenkins plugin that allows to create globally accessible properties in YAML format]]
- [[https://github.com/jenkinsci/groovy-events-listener-plugin][jenkinsci/groovy-events-listener-plugin: A Jenkins plugin, which executes groovy code when an event occurs.]]
...
- [[https://github.com/jenkinsci/platformlabeler-plugin][jenkinsci/platformlabeler-plugin: Label Jenkins agents based on their operating system]]
...
- [[https://updates.jenkins-ci.org/latest/][Permalinks to latest plugin files]]
...
- [[https://github.com/promhippie/jenkins_exporter][promhippie/jenkins_exporter: Prometheus exporter for Jenkins]]
...
* Cheatsheet
  ...
  - Delete a hang job when cannot stop, kill via Web UI
    #+begin_src groovy
      def jobname = "nixos/web/master"
      def buildnum = 83

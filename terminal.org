...
- [[https://github.com/achristmascarl/rainfrog][achristmascarl/rainfrog: 🐸 a database tool for the terminal]]
...
- [[https://github.com/alejandroqh/term39][alejandroqh/term39: A modern, retro-styled terminal multiplexer built with Rust.]]
...
- [[https://github.com/charmbracelet/sequin][charmbracelet/sequin: Human-readable ANSI sequences 🪩]]
- [[https://github.com/chrismccord/webtmux][chrismccord/webtmux: Web-based terminal with tmux-specific features]]
...
- [[https://github.com/cxreiff/ttysvr][cxreiff/ttysvr: Screensavers for your terminal.]]
...
- [[https://github.com/emprcl/runal][emprcl/runal: a creative coding environment for the terminal :fireworks:]]
...
- [[https://github.com/Julien-cpsn/desktop-tui][Julien-cpsn/desktop-tui: A desktop environment without graphics]]
...
- [[https://github.com/klpod221/kerminal][klpod221/kerminal: // Modern Terminal Emulator & SSH Manager]]
...
- [[https://github.com/Levizor/tray-tui][Levizor/tray-tui: System tray in your terminal]]
...
- [[https://github.com/magiblot/tvterm][magiblot/tvterm: A terminal emulator that runs in your terminal. Powered by Turbo Vision.]]
- [[https://github.com/meefik/websocket.sh][meefik/websocket.sh: The cross platform WebSocket implementation for UNIX shell]]
- [[https://github.com/MidnightCommander/mc/tree/master][MidnightCommander/mc: Midnight Commander's repository]]
- [[https://github.com/mitjafelicijan/xdgctl][mitjafelicijan/xdgctl: TUI for managing XDG default applications]]
- [[https://github.com/mmulet/term.everything][mmulet/term.everything: Run any GUI app in the terminal❗]]
- [[https://github.com/nasa42/webterm][nasa42/webterm: Securely access a server's terminal even when they are behind firewalls]]
...
- [[https://github.com/pamburus/termframe][pamburus/termframe: 📸 Terminal output SVG screenshot tool]]
...
- [[https://github.com/pipelight/boulette][pipelight/boulette: A terminal confirmation prompt that prevents you from accidentally damaging remote hosts.]]
...
- [[https://github.com/ravachol/kew][ravachol/kew: Music for the Shell.]]
- [[https://github.com/rcarmo/webterm][rcarmo/webterm: Yet another web terminal, but with style]]
- [[https://github.com/rewindtty/rewindtty][rewindtty/rewindtty: A terminal session recorder and replayer written in C that allows you to capture and replay terminal sessions with precise timing.]]
...
- [[https://github.com/sectore/timr-tui][sectore/timr-tui: TUI to organize your time: Pomodoro, Countdown, Timer, Event.]]
- [[https://github.com/Skardyy/mcat][Skardyy/mcat: Terminal image, video, and Markdown viewer]]
...
- [[https://github.com/tattoy-org/tattoy][tattoy-org/tattoy: A text-based compositor for modern terminals]]
- [[https://github.com/taviso/wpunix][taviso/wpunix: WordPerfect for UNIX Character Terminals]]
- [[https://github.com/Termix-SSH/Termix?tab=License-1-ov-file#readme][Termix-SSH/Termix: Termix is a web-based server management platform with SSH terminal, tunneling, and file editing capabilities.]]
- [[https://github.com/thomasschafer/scooter][thomasschafer/scooter: Interactive find-and-replace in the terminal]]
- [[https://github.com/tsoding/img2term][tsoding/img2term: Print an image in the terminal using the term 256 colors]]
- [[https://github.com/unkn0wn-root/resterm][unkn0wn-root/resterm: Terminal client for HTTP/GraphQL/gRPC with support for SSH tunnels, WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.]]
...
- [[https://github.com/weedonandscott/trolley][weedonandscott/trolley: Run terminal apps anywhere]]
...
- [[https://github.com/yassinebridi/serpl][yassinebridi/serpl: A simple terminal UI for search and replace, ala VS Code.]]

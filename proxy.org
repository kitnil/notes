...
- [[https://github.com/connet-dev/connet][connet-dev/connet: A p2p reverse proxy with NAT traversal. Inspired by frp, rathole and ngrok]]
...
- [[https://github.com/flipt-io/reverst][flipt-io/reverst: Reverse Tunnels in Go over HTTP/3 and QUIC]]
- [[https://github.com/gfpcom/free-proxy-list][gfpcom/free-proxy-list: 🚀 The Best Free HTTP, SOCKS4/SOCKS5, SSL,SS/SSR Proxy List,V2Ray/XRay(Vmess/Vless) Configs, Tuic, Wireguard, Hyeseria, Trojan-Go/Trojan-GFW Servers - 🔄 Updated Every 30 Minutes⏰]]
- [[https://github.com/google/inverting-proxy][google/inverting-proxy: Reverse proxy that inverts the direction of traffic]]
- [[https://github.com/Gouryella/drip][Gouryella/drip: Self-hosted tunneling solution to expose localhost securely - unlimited bandwidth, no third-party servers]]
...
- [[https://github.com/jasonwong1991/easy_proxies][jasonwong1991/easy_proxies: A proxy node pool management tool based on sing-box, supporting multiple protocols, automatic failover and load balancing. 基于 sing-box 的代理节点池管理工具，支持多协议、多节点自动故障转移和负载均衡。]]
...
- [[https://github.com/linksocks/linksocks][linksocks/linksocks: A SOCKS proxy implementation over WebSocket protocol.]]
...
- [[https://github.com/Madh93/prxy][Madh93/prxy: 🔌 Command-line reverse proxy for forwarding HTTP requests through an outbound proxy]]
...
- [[https://github.com/perfect-panel/server][perfect-panel/server: PPanel is a pure, professional, and perfect open-source proxy panel tool, designed to be your ideal choice for learning and practical use.]]
...
- [[https://github.com/SenseUnit/dumbproxy][SenseUnit/dumbproxy: Simple, scriptable, secure forward proxy]]
...
* Tools
- [[https://github.com/danthegoodman1/specificproxy][danthegoodman1/specificproxy: HTTP Proxy that allows you to define the IP address at connect time]]
- [[https://github.com/dis0rder0x00/stillepost][dis0rder0x00/stillepost: Using Chromium-based browsers as a proxy for C2 traffic.]]
- [[https://github.com/nadoo/glider][nadoo/glider: glider is a forward proxy with multiple protocols support, and also a dns/dhcp server with ipset management features(like dnsmasq).]]
- [[https://github.com/throneproj/Throne][throneproj/Throne: Cross-platform GUI proxy utility (Empowered by sing-box)]]
- [[https://github.com/vicanso/pingap][vicanso/pingap: A reverse proxy like nginx, built on pingora, simple and efficient.]]
- [[https://github.com/x011/smtp-tunnel-proxy][x011/smtp-tunnel-proxy: A high-speed covert tunnel that disguises TCP traffic as SMTP email communication to bypass Deep Packet Inspection (DPI) firewalls.]]

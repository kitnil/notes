...
- [[https://github.com/bones-ai/bevy-2d-shooter][bones-ai/bevy-2d-shooter: A 2d top-down shooter written in Bevy, capable of handling 100K enemies]]

- [[https://github.com/Rucadi/nix-gamemod][Rucadi/nix-gamemod]]

- [[https://habr.com/ru/articles/340886/][OpenApoc — Фанатам X-Com Apocalypse посвящается / Хабр]]

- [[https://github.com/LangUMS/langums][LangUMS/langums: Programming language and compiler for StarCraft: Brood War custom (UMS) maps]]

- [[https://github.com/phoboslab/wipeout-rewrite][phoboslab/wipeout-rewrite: Re-implementation of the 1995 PSX game wipEout.]]

- [[https://github.com/arkivanov/Minesweeper][arkivanov/Minesweeper: Minesweeper game implemented in Kotlin and Compose Multiplatform]]

- [[https://github.com/BreakingLead/blockworld][BreakingLead/blockworld: A new minecraft-like game implementation. It aims to be source code-level compatible for minecraft mods.]]

- [[https://github.com/palerdot/wordl-rs][palerdot/wordl-rs: Terminal wordle. Web like GUI with Keyboard hints, guess reveal animations etc.]]
...
- [[https://github.com/thijsvanloef/palworld-server-docker?tab=readme-ov-file][thijsvanloef/palworld-server-docker: A Docker Container to easily run a Palworld dedicated server.]]

- [[https://github.com/Hoshinonyaruko/palworld-go][Hoshinonyaruko/palworld-go: Pal World all-in-one webui for pc and mobile devices.]]

- [[https://en.wikipedia.org/wiki/MDK2][MDK2 - Wikipedia]] is a 2000 third-person shooter, action-adventure video game developed by BioWare.

- [[https://github.com/pod-arcade/pod-arcade][pod-arcade/pod-arcade: Play Retro Games with your friends, directly in your browser!]]

- [[https://github.com/marc0x1/Wayland-Native-Games-Compatibility-List][marc0x1/Wayland-Native-Games-Compatibility-List: A curated list of trick to run native linux games on Wayland]]

- Star Wars: Dark Forces, Dark Forces 2 и Mysteries of the Sith, DF2JK1
...
- [[https://tetr.io/][TETR.IO: Free open source online multiplayer with custom rooms that you can use to play with viewer.]]

- [[https://github.com/Syn-Nine/galaxion-trade-empire][Syn-Nine/galaxion-trade-empire: Space Trading Game made in Rust]]

- [[https://www.youtube.com/watch?v=9CU-ZtzqZiI][(2) Doom - The BEST Roguelike You've Never Played & it's FREE! - YouTube]]

- [[https://gitlab.com/stone-kingdoms/stone-kingdoms][Stone Kingdoms / stone-kingdoms: A real-time strategy game made with LÖVE based on the original Stronghold by Firefly studios. · GitLab]]

- [[https://gitlab.com/Isleward/isleward][Isleward / isleward: The moddable, multiplayer roguelike. · GitLab]]

- https://mod.io/g/openxcom/m/the-x-com-files

- [[https://www.projectdiablo2.com/][Project Diablo 2]]

- [[https://github.com/GaijinEntertainment/DagorEngine][GaijinEntertainment/DagorEngine: Dagor Engine and Tools source code from Gaijin Games KFT]]

- [[https://bgammon.org/][bgammon.org - Free Online Backgammon]]

- [[https://en.wikipedia.org/wiki/Legacy_of_Kain][Legacy of Kain - Wikipedia]]

- [[https://github.com/wanjohiryan/Arc3dia][wanjohiryan/Arc3dia: Self-Hosted Stadia: Play with your friends online from any device and at any time]]

- [[https://howlongtobeat.com/][HowLongToBeat.com | Game Lengths, Backlogs and more!]]

- [[https://en.wikipedia.org/wiki/Project_Nomads][Project Nomads - Wikipedia]]

- [[https://github.com/afwbkbc/glsmac][afwbkbc/glsmac: Unofficial open-source OpenGL/SDL2 reimplementation of Sid Meier's Alpha Centauri ( + Alien Crossfire )]]

- [[https://github.com/aciceri/scmrl][aciceri/scmrl: An embryonal stage roguelike written in Scheme]]

- [[https://www.pcgamingwiki.com/wiki/Home][PCGamingWiki PCGW - an encyclopedia of PC game fixes]]

- [[https://store.steampowered.com/app/1049410/Superliminal/][Superliminal on Steam]]

- [[https://github.com/ill-inc/biomes-game][ill-inc/biomes-game: Biomes is an open source sandbox MMORPG built for the web using web technologies such as Next.js, Typescript, React and WebAssembly.]]

- [[https://github.com/qdm12/teamspeak-server-alpine][qdm12/teamspeak-server-alpine: Minimalist Teamspeak 3 server Docker container]]

- [[https://github.com/qdm12/cod4-docker][qdm12/cod4-docker: Runs a Call of duty 4 Modern Warfare (cod4x) dedicated server in a Docker container.]]

- [[https://github.com/SoftbearStudios/mk48][SoftbearStudios/mk48: Mk48.io ship combat game]]
- [[https://github.com/SoftbearStudios/kiomet][SoftbearStudios/kiomet: Kiomet.com real-time strategy game]]

- [[https://github.com/wenta/rapid-dominance][wenta/rapid-dominance: Turn-based strategy game]]

- [[https://github.com/quakeforge/quakeforge][quakeforge/quakeforge]]

- [[https://github.com/diasurgical/devilutionX][diasurgical/devilutionX: Diablo build for modern operating systems]]

- [[https://github.com/Tencent/puerts][Tencent/puerts: PUER(普洱) Typescript. Let's write your game with TypeScript in UE or Unity.]]

- [[https://github.com/R3nzTheCodeGOD/R3nzSkin][R3nzTheCodeGOD/R3nzSkin: Skin changer for League of Legends (LOL)]]

- [[https://en.wikipedia.org/wiki/IGDB][The Internet Game Database (IGDB) is an online database about video games - Wikipedia]]

- [[https://github.com/ppy/osu][ppy/osu: rhythm is just a *click* away!]]

- [[https://d4reflection.org/][D4 Reflection]]

- [[https://github.com/Croquetx/thecolony][Croquetx/thecolony: First realtime 3D adventure/shooter]]

- [[https://github.com/zurdi15/romm][zurdi15/romm: RomM (Rom Manager) is a web based retro roms manager integrated with IGDB.]]

- [[https://github.com/StrongPC123/Far-Cry-1-Source-Full][StrongPC123/Far-Cry-1-Source-Full: Far Cry 1 Full Source (Developed by CryTek). For NON COMMERCIAL Purposes only. Leaked.]]
...
- [[https://github.com/StanislavPetrovV/DOOM-style-Game][StanislavPetrovV/DOOM-style-Game: DOOM-style 3D (raycasting) Game in Python Pygame]]
  - [[https://www.youtube.com/watch?v=ECqUrT7IdqQ][(7) Creating a DOOM (Wolfenstein) - style 3D Game in Python - YouTube]]
...
- [[https://github.com/dmitrygerasimuk/open-pole-dos][dmitrygerasimuk/open-pole-dos: OPENPOLE: реверс порт классической игры «Поле Чудес» для MS-DOS на C для MS-DOS]]
...
- [[https://github.com/Wemino/EchoPatch][Wemino/EchoPatch: Modernizes F.E.A.R. and its expansions with HUD scaling, high-framerate optimizations, controller support, and other quality-of-life enhancements]]

- [[https://github.com/xoxor4d/gta4-rtx][xoxor4d/gta4-rtx: GTAIV RTX Remix Compatibility Mod]]

- [[https://github.com/UZDoom/UZDoom][UZDoom/UZDoom: UZDoom is a feature centric port for all Doom engine games, based on GZDoom, adding an advanced renderer and powerful scripting capabilities]]

- [[https://github.com/cryptocode/terminal-doom][cryptocode/terminal-doom: Play DOOM in modern terminals]]

- [[https://github.com/VadimBoev/FlappyBird][VadimBoev/FlappyBird: Less than 100 Kilobytes. Works for Android 5.1 and above]]

- [[https://github.com/IntQuant/noita_entangled_worlds][IntQuant/noita_entangled_worlds: True coop multiplayer mod for Noita.]]

- [[https://github.com/jacopograndi/tage][jacopograndi/tage: turn based empire warfare in the terminal]]
...
- [[https://github.com/houmain/crown][houmain/crown: A work in progress Jump'n'Run game]]
- [[https://github.com/magarena/magarena][magarena/magarena: Magarena is a single-player fantasy card game played against a computer opponent.]]
...
* Racing
- [[https://store.steampowered.com/app/1664220/TRAIL_OUT/][TRAIL OUT on Steam]]

* Risen 3
** [[https://steamcommunity.com/app/249230/discussions/0/528398719799479990/][Enhanced Edition fps issues]]

What's that about?

I myself alongside with many other people noticed that after EE update there
were microstuttering and microfreezing and/or big fps loss.

What was the problem?

I had ~40 fps with ultra settings. Setting the game to lowest settings didn't
improve fps not even by 1. Alongside with that there were microlags, which
made 'smooth' experience stutter.

Any fix?

Here's the one thing that helped me, and it doesn't involve hardware/drivers
tuning.

1. Find *ConfigDefault.xml* in *Steam\SteamApps\common\Risen 3\data\ini\*

2. Find this line (just search word 'fps'):
: <Window Top="0" SafetyFramePercentage="0.0" Right="1024" RefreshRate="0" Name="Risen 3 - Titan Lords" Left="0" FullScreen="false" FPSLimitToRefreshRate="true" FPSLimit="0" Center="false" CaptureCursor="true" Bottom="768" AdapterNumber="0"></Window>
...
That solved the problem for me. Now on my midrange (i5 4430, GTX 770 2gb, 8gb
ram) rig I get 70+ fps.

** [[https://steamcommunity.com/app/249230/discussions/0/527273789696733262/][Weird Sound bug near waterfalls and when it rains]]
*** [[https://steamcommunity.com/app/249230/discussions/0/527273452883157387/][Sound missing during dialogs and cutscenes]]
It seems to be an issue on Antigua. here is an answer from a previous post i
copied.  

I did this and it seems to have helped..
  
Open the ConfigDefault.xml file in Risen3/Data/ini with notepad, and change
maxchannels to 256, that will solve all your sound problems.
* Tools
- [[https://github.com/ruffsl/CtrlAssist][ruffsl/CtrlAssist: Controller Assist for gaming on Linux]]

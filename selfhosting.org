...
- [[https://blog.scaleway.com/40-open-source-projects/][40+ of the best open-source tools to build your startup]]
- [[https://github.com/abhinavxd/libredesk][abhinavxd/libredesk: Modern, open source, self-hosted customer support desk. Single binary app.]]
...
- [[https://github.com/beclab/Olares][beclab/Olares: Olares: An Open-Source Personal Cloud to Reclaim Your Data]]
...
- [[https://github.com/DioCrafts/OxiCloud][DioCrafts/OxiCloud: ☁️ OxiCloud server, efficient and secure way to save all your data]]
...
- [[https://github.com/donetick/donetick][donetick/donetick: Donetick an open-source, user-friendly app for managing tasks and chores, featuring customizable options to help you and others stay organized]]
...
- [[https://github.com/flexprice/flexprice][flexprice/flexprice: Usage-based pricing and billing for developers 🔓 Cloud or self-hosted ⚙️ No-code UI 💰 Realtime usage metering 🎟 Credits & top-ups 🔑 Control feature access]]
...
- [[https://github.com/hmontazeri/mushak][hmontazeri/mushak: Mushak is a CLI tool that enables PaaS-like deployments to your own Linux server or home lab.]]
- [[https://github.com/hsa00000/Urocissa][hsa00000/Urocissa: Urocissa is a self-hosted photos gallery designed to serve massive collections, capable of handling millions of images and videos. It is built using Rust and Vue.]]
...
- [[https://github.com/karakeep-app/karakeep][karakeep-app/karakeep: A self-hostable bookmark-everything app (links, notes and images) with AI-based automatic tagging and full text search]]
- [[https://github.com/kOlapsis/shm][kOlapsis/shm: 🛡️ Privacy-first, Agnostic Telemetry for Self-Hosted Software.]]
...
- PhotoPrism
- PhotoShow
- [[https://github.com/raghavyuva/nixopus][raghavyuva/nixopus: Open Source Alternative to vercel, heroku, netlify with simplified workflows]]
...
- [[https://github.com/taubyte/tau][taubyte/tau: Open source distributed Platform as a Service (PaaS). A self-hosted Vercel / Netlify / Cloudflare alternative.]]
- [[https://github.com/tellform/tellform][tellform/tellform: Free Opensource Alternative to TypeForm or Google Forms]]
- [[https://github.com/timelinize/timelinize?tab=readme-ov-file][timelinize/timelinize: Store your data from all your accounts and devices in a single cohesive timeline on your own computer]]
...
- [[https://github.com/Warp-net/warpnet][Warp-net/warpnet: WarpNet is a decentralized, peer-to-peer social network inspired by Twitter, built with Go. It runs without central servers, using Noise protocol for inter-node communication and built-in local storage. WarpNet is censorship-resistant, scalable, and fully open-source.]]
- [[https://github.com/Wervice/zentrox][Wervice/zentrox: A powerful (home) server admininistration tool written in Rust]]
...
- [[https://github.com/Zhoros/SuperBin][Zhoros/SuperBin: Super Bin - Pastebin, File Sharing and URL Shortener with Password, Curl and QR support]]
- [[https://github.com/zserge/pennybase][zserge/pennybase: Poor man's Backend-as-a-Service (BaaS), similar to Firebase/Supabase/Pocketbase]]
...
* News
- [[https://github.com/ourongxing/newsnow][ourongxing/newsnow: Elegant reading of real-time and hottest news]]

* Navigation
- [[https://github.com/AnmolSaini16/mapcn][AnmolSaini16/mapcn: Beautiful map components. 100% Free, Zero config, one command setup.]]

* Wallets
- [[https://github.com/openfort-xyz/opensigner][openfort-xyz/opensigner: Open-source and self-hostable wallet key management. Create non-custodial wallets for users in Ethereum and Solana]]
* Website
- [[https://github.com/stormkit-io/stormkit-io?tab=License-1-ov-file#readme][stormkit-io/stormkit-io: Self-hostable alternative to Vercel/Netlify. Deploy modern web apps with automated CI/CD, custom domains, and environment management.]]

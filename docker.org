...
- music
  : docker run -d --name navidrome --restart=unless-stopped --user $(id -u):$(id -g) -v /srv/audio:/music:ro -v /var/lib/navidrome:/data -p 127.0.0.1:4533:4533 -e ND_LOGLEVEL=debug deluan/navidrome:latest

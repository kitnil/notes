...
- [[https://github.com/deckrun/dockadvisor][deckrun/dockadvisor: Lightweight Dockerfile linter that helps you write better Dockerfiles. Get instant feedback with quality scores, security checks, and 60+ best practice rules.]]
...
- [[https://github.com/eznix86/docker-registry-ui][eznix86/docker-registry-ui: Yet another docker registry UI]]
- [[https://github.com/fr4nsys/usulnet][fr4nsys/usulnet: Open-source Docker infrastructure platform. One web UI — containers, security, DNS, VPN, monitoring, backups, reverse proxy, terminal, and multi-node orchestration. Replace a dozen tools with one.]]
...
- [[https://github.com/h33333333/xray][h33333333/xray: A Docker image layer inspector]]
...
- [[https://github.com/jr-k/d4s][jr-k/d4s: 🍊 A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s.]]
...
- [[https://github.com/robertpsoane/ducker][robertpsoane/ducker: A slightly quackers Docker TUI based on k9s 🦆]]
...
- [[https://github.com/thobiasn/tori-cli][thobiasn/tori-cli: Lightweight remote Docker monitoring with alerting. Single binary, zero exposed ports, SSH-only access.]]

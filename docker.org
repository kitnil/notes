...
: docker run -d --name=firefox --security-opt seccomp=unconfined -e PUID=1000 -e PGID=1000 -e TZ=Europe/London --shm-size="1gb" --restart unless-stopped --network br155_net lscr.io/linuxserver/firefox:latest

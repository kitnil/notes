:PROPERTIES:
:ID:       73f3cbf1-541d-4fd1-8b81-453084546c79
:END:
#+title: TODO
...
* TODO split git commit to a separate stage in ~/src/awesome
...
* TODO router{1,2}.intr cannot resolve domains via nsX-XX.intr

* TODO Fix LSP deprecation on my Emacs installation
#+begin_quote
LSP :: Connected to [jdtls:28364].
LSP :: `company-lsp` is not supported anymore. Using `company-capf` as the `lsp-completion-p
#+end_quote

* TODO Fix "zabbix_server -R config_cache_reload" error zabbix_server [5683]: cannot open PID file [/tmp/zabbix_server.pid]: [2] No such file or directory

* TODO sudo -u postgres $(which pg_dump) zabbix > /srv/backups/zabbix-2020-11-29.psql

* TODO [[https://distrowatch.com/11099][Distribution Release: NethServer 7.9]]
- [[https://distrowatch.com/11098][Distribution Release: Univention Corporate Server 4.4-7]]

* TODO jenkins.intr      
2046 root      20   0  219412   3244   2784 R  23.3   0.0   0:32.10 chown --recursive jenkins:jenkins /var/lib/jenkins

* TODO

- [[https://www.ngohq.com/linpack-xtreme.html][Linpack Xtreme]]

* TODO Fix ipv6 mysql for support rooms on web

* TODO [[https://wiki.archlinux.org/index.php/Core_dump][Core dump - ArchWiki]]

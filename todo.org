...
забери .nixos юзера jenkins на сервере jenkins, а потом клонь репу nixops с гитлаба и
nixops modify ./test.nix -d shared-test-dp
...
после этого
nixops deploy -d shared-test-dp
будет тебе сразу все деплоить на оба веба

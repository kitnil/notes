...
* TODO
  ...
  https://cerberus.intr/index.php/profiles/ticket/HQ-86715-232/conversation
  #+begin_example
    2020-07-11T10:43:08.613912072Z billing2_control.2.ukn9v226z0u7@dh2-mr.intr    | ==> /var/log/app/app.log <==
    2020-07-11T10:43:08.613922326Z billing2_control.2.ukn9v226z0u7@dh2-mr.intr    | 11-07-2020 13:43:07 CRIT (2): XML-RPC Fault: (84f3be8d): RpcClient.php:39 'file_get_contents(https://rpc.registrant.ru/): failed to open stream: HTTP request failed! HTTP/1.1 403 Forbidden
    2020-07-11T08:06:52.138436378Z billing2_control.1.y4zkbu5m6azk@dh3-mr.intr    | ==> /var/log/app/app.log <==
    2020-07-11T08:06:52.138446100Z billing2_control.1.y4zkbu5m6azk@dh3-mr.intr    | 11-07-2020 11:06:51 CRIT (2): XML-RPC Fault: (c9b92aea): RpcClient.php:39 'file_get_contents(https://rpc.registrant.ru/): failed to open stream: HTTP request failed! HTTP/1.1 403 Forbidden
  #+end_example
...
* TODO [[file:~/archive/src/ssh2docker/auth.go::cmd.Env = config.Env.List()][ssh2docker]]
...
* TODO [[https://gitlab.intr/zdetovetskiy/nixos/-/commit/a708a4f6242d92efaa291a961eaef3493db7ad37][Store Bind zone locally]]

* TODO webssh.ci.intr on NGINX at ci.intr
...
- [[https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&ved=2ahUKEwih5qSc_8zrAhURiYsKHdOCA3cQFjACegQIBhAB&url=https%3A%2F%2Fmariadb.org%2Fwp-content%2Fuploads%2F2020%2F02%2FeBPF-and-Dynamic-Tracing-for-MariaDB-DBAs-MariaDB-Day-During-FOSDEM-2020.pdf&usg=AOvVaw2rBl4NXyHZ9t7k4FmxXWrm][eBPF and Dynamic Tracing for MariaDB DBAs mariadb.org › wp-content › uploads › 2020/02 › eBPF-...]]
- [[http://www.brendangregg.com/Slides/LISA13_Flame_Graphs.pdf][LISA13_Flame_Graphs.pdf]]
...
* TODO
#+begin_example
ad42c20921235532e80e776fd55090127389208b is the first bad commit
commit ad42c20921235532e80e776fd55090127389208b
Author: Mark H Weaver <mhw@netris.org>
Date:   Wed Sep 9 14:32:04 2020 -0400
...
oleg@guixsd ~/src/guix-master$ git bisect log
git bisect start
# bad: [140da556be06442192fbae5e2a07357f26fbc26b] ui: Lexicographically sort transaction entries based on their package name.
git bisect bad 140da556be06442192fbae5e2a07357f26fbc26b
# good: [81ea278e05986f9ccee078bd00d4d7fc309dd19c] gnu: sbcl-ironclad: Update to 0.51.
git bisect good 81ea278e05986f9ccee078bd00d4d7fc309dd19c
# bad: [af62950fc05f265c6c29c5973a2029a9cfdd0d30] gnu: burp: Update to 2.3.34 [security fixes].
git bisect bad af62950fc05f265c6c29c5973a2029a9cfdd0d30
# good: [dc89d17164011516c58070baa3b3ffde7eb758b4] gnu: emacs-org: Update to 9.3.7.
git bisect good dc89d17164011516c58070baa3b3ffde7eb758b4
# good: [086ae880002806ed2db9b597f7ad54974c3731b2] gnu: emacs-sly: Update to 20200903.
git bisect good 086ae880002806ed2db9b597f7ad54974c3731b2
# bad: [db0109be42547d5dbb0fc1eb8ae30ccc968ed88b] gnu: dovecot: Set moduledir to global directory.
git bisect bad db0109be42547d5dbb0fc1eb8ae30ccc968ed88b
# good: [1f56ec08af704bdc7aa3e143bf5ce351c5306dea] gnu: Add r-loomr.
git bisect good 1f56ec08af704bdc7aa3e143bf5ce351c5306dea
# good: [0f8db4dc88f2b0bfd50d10001b0a39c751a9c6c0] Revert "gnu: Add r-loomr."
git bisect good 0f8db4dc88f2b0bfd50d10001b0a39c751a9c6c0
# bad: [ad42c20921235532e80e776fd55090127389208b] gnu: linux-libre: Update to 5.8.8.
git bisect bad ad42c20921235532e80e776fd55090127389208b
# good: [eb15d38162743feee686e16e084d927a3e98883f] gnu: mercurial: Update to 5.5.1.
git bisect good eb15d38162743feee686e16e084d927a3e98883f
# first bad commit: [ad42c20921235532e80e776fd55090127389208b] gnu: linux-libre: Update to 5.8.8.
#+end_example
...
* TODO Broken guix time-machine

oleg@guixsd ~/src/guile-ihs$ mv ~/.cache/guix ~/.cache/guix~
oleg@guixsd ~/src/guile-ihs$ command guix time-machine --commit=5b7a1cb077931a020c0b7e3b12f12a7bda221d96 -- environment --ad-hoc bash
Updating channel 'guix' from Git repository at 'https://git.savannah.gnu.org/git/guix.git'...
guix time-machine: error: Git error: the requested type does not match the type in the ODB
oleg@guixsd ~/src/guile-ihs$ guix describe 
Generation 35   Sep 12 2020 13:31:37    (current)
  guix 5f5ff26
    repository URL: https://git.savannah.gnu.org/git/guix.git
    branch: master
    commit: 5f5ff266e594948b02005ae46d47ebff7654b8c3

...
мне надо свалить в магаз. Закончите тут без меня? Надо сделать пустым DEBUG в докерфайле, а в hms.yml перенести DEBUG="-Dcom.sun.management.jmxremote.port=28075 -Dcom.sun.management.jmxremote.authenticate=false  -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.rmi.port=28075 -Djava.rmi.server.hostname=172.16.103.158" для второго стека и DEBUG="-Dcom.sun.management.jmxremote.port=18075 -Dcom.sun.management.jmxremote.authenticate=false  -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.rmi.port=18075 -Djava.rmi.server.hostname=172.16.103.158" для первого
19:18
там же, рядом с HMS_INSTANCE_NAME
19:19
ну или при следующем деплое все слетит)

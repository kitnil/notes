...
* TODO Add script
: ansible -uroot -i192.168.100.29,192.168.100.31,192.168.100.32, --extra-vars="ansible_ssh_common_args='-o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no'" 192.168.100.29,192.168.100.31,192.168.100.32 -m ping

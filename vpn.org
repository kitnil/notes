...
- [[https://github.com/AkinoKaede/asport][AkinoKaede/asport: A quick and secure reverse tunnel based on QUIC. Written in Rust, an alternative to frp and ngrok.]]
...
- [[https://github.com/doxx/doxx.net][doxx/doxx.net: Advanced VPN, Parallel Internet, and De-Location Platform]]
- [[https://github.com/EasyTier/EasyTier][EasyTier/EasyTier: A simple, decentralized mesh VPN with WireGuard support.]]
...
- [[https://github.com/nymtech/nym-vpn-client][nymtech/nym-vpn-client: Cross-platform open source VPN client built in Rust, with mixnet anonymity and WireGuard speed. Protects metadata, not just IP addresses. Zero-knowledge payments for unlinkable online activities.]]
- [[https://github.com/octelium/octelium][octelium/octelium: A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.]]
...
- [[https://github.com/stealth/fraud-bridge][stealth/fraud-bridge: ICMP and DNS tunneling via IPv4 and IPv6]]
...
- [[https://github.com/yosebyte/passport][yosebyte/passport: Powerful yet simple solution for network tunneling and port forwarding with access control all using 1-URL command.]]
